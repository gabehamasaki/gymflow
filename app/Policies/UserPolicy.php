...
class UserPolicy
{
    ...
    {
        return $user->hasPermission('store_user');
    }
    ...
    {
        return $user->hasPermission('restore_user') || $user->id === $model->id;
    }
    ...
    {
        return $user->hasPermission('force_delete_user') || $user->id === $model->id;
    }
}
